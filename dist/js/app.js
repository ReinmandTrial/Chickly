      ...
      2: function (module, exports, __webpack_require__) {
         ...
         /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */ window.Element &&
            ...
            (function (e, t) {
               ...
               'undefined' != typeof __webpack_require__.g ? __webpack_require__.g : 'undefined' != typeof window ? window : this,
               function (M) {
                  'use strict';
                  var q = {
                                    ...
                                    l || (l = e),
                                       ...
                                       (function (e, t) {
                                          ...
                                          if (e == t || n == t || (s < t && M.innerHeight + n) >= v)
                                             return C.cancelScroll(!0), x(a, t, c), H('scrollStop', i, a, r), !(O = l = null);
   ...
   (() => {
      ...
      function updateSlides() {
         ...
         const shouldResetSlideSize =
            ...
            params.breakpoints &&
            Object.keys(params.breakpoints).filter((key) => 'undefined' !== typeof params.breakpoints[key].slidesPerView).length > 0;
      ...
      function updateClickedSlide(e) {
         ...
         if (params.slideToClickedSlide && void 0 !== swiper.clickedIndex && swiper.clickedIndex !== swiper.activeIndex)
      ...
      const events = (swiper, method) => {
         ...
         if (!support.touch) {
            ...
            const passiveListener =
               'touchstart' === touchEvents.start && support.passiveListener && params.passiveListeners
                  ? {
                       passive: true,
                       capture: false,
                    }
      ...
      function moduleExtendParams(params, allModulesParams) {
         return function extendParams(obj) {
            ...
            if (['navigation', 'pagination', 'scrollbar'].indexOf(moduleParamName) >= 0 && true === params[moduleParamName])
      ...
      DynamicAdapt.prototype.moveBack = function (parent, element, index) {
         ...
         if (void 0 !== parent.children[index]) parent.children[index].insertAdjacentElement('beforebegin', element);
