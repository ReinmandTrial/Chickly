export const translations = {
   eng: {
      ...
      conditionSlideSubText3:
         'Smart-contract check its current balance and charge an additional +0.15% up to your earnings for every 400 BNB on balance. Current bonus : 0.0%',
      //How it work========================================================================================================================================================
      ...
      schemeCardTitle1:
         '<span>BNB turnover</span> <span data-help="Click Withdraw button, and you will get instantly all your " class="_icon-info"></span>',
      schemeCardTitle2:
         '<span>If you do not withdraw profit</span> <span data-help="Click Withdraw button, and you will get instantly all your " class="_icon-info"></span>',
   ...
   esp: {
      ...
      schemeCardTitle1:
         '<span>Volumen de BNB</span> <span data-help="Haga click en el botón de Retiro para obtener todas las ganancias de sus depósitos y bonificaciones asociadas en una sola transacción. Su bonificación de permanencia de fondos se reiniciará." class="_icon-info"></span>',
      schemeCardTitle2:
         '<span>Si no se retiran ganancias</span> <span data-help="Haga click en el botón de Retiro para obtener todas las ganancias de sus depósitos y bonificaciones asociadas en una sola transacción. Su bonificación de permanencia de fondos se reiniciará." class="_icon-info"></span>',
   ...
   vnm: {
      ...
      schemeCardTitle1:
         '<span>Doanh số BNB</span> <span data-help="Nhấn nút Rút để nhận tất cả thu nhập từ số tiền nạp vào để đầu tư và thưởng giới thiệu chỉ với một giao dịch. Thưởng cho việc giữ lợi nhuận của bạn sẽ bị đặt lại." class="_icon-info"></span>',
      schemeCardTitle2:
         '<span>Nếu bạn không rút lợi nhuận</span> <span data-help="Nhấn nút Rút để nhận tất cả thu nhập từ số tiền nạp vào để đầu tư và thưởng giới thiệu chỉ với một giao dịch. Thưởng cho việc giữ lợi nhuận của bạn sẽ bị đặt lại." class="_icon-info"></span>',
   ...
   prt: {
      ...
      schemeCardTitle1:
         '<span>Volume de negociações de BNB</span> <span data-help="Clique no botão Sacar para obter todos os seus ganhos de depósitos e bônus de afiliados de uma só vez com uma única transação. Seu bônus pessoal de hold será redefinido dessa forma." class="_icon-info"></span>',
      schemeCardTitle2:
         '<span>Se você não sacar o lucro</span> <span data-help="Clique no botão Sacar para obter todos os seus ganhos de depósitos e bônus de afiliados de uma só vez com uma única transação. Seu bônus pessoal de hold será redefinido dessa forma." class="_icon-info"></span>',
